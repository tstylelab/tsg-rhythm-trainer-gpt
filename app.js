const patterns = [
  {
    title: "4分音符だけ",
    level: "初級",
    goal: "まずは足で1,2,3,4を感じながら、手で同じ場所をタップ。",
    meter: "4/4",
    bars: 2,
  ...
  },
  {
    title: "8分 表と裏",
    level: "初級",
    goal: "ワン・エン・ツー・エンを声に出しながら、均等にタップ。",
    meter: "4/4",
    bars: 2,
  ...
  },
  {
    title: "ロックの定番",
    level: "上級",
    goal: "8分と16分が混じる実践的なパターン。止まらず拍を刻みます。",
    meter: "4/4",
    bars: 2,
  ...
  },
  {
    title: "シャッフル感",
    level: "上級",
    goal: "跳ねた裏拍を想定した練習。LISTENで感じを確認してから開始。",
    meter: "4/4",
    bars: 2,
    swing: true,
  ...
  },
  {
    title: "2小節フレーズ",
    level: "プロ",
    goal: "1小節目と2小節目で形が変わる、曲中フレーズ向けの練習。",
    meter: "4/4",
    bars: 2,
